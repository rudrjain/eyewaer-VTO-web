...
if (!window.MEDIAPIPEAR.FACE) {
  window.MEDIAPIPEAR.FACE = {};
}

window.MEDIAPIPEAR.FACE.MediapipeARThree = MediapipeARThree;
//window.MEDIAPIPEAR.FACE.THREE = THREE;
